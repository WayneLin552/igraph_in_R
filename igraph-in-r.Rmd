...
Network analysis, including social networks, biological networks, transportation networks and so on, has wide application in real life. A good network is an abstraction of the topological features among entities. Thus, a nice and clear visualization of complex network is necessary since it can give us a straightforward understanding of entities’ connections. Here, we will explore how to generate a good network visualization using R.

### Need it addresses

This will be a very brief introduction about a R package called igraph, which is a complex network analysis tool. It contains commonly used and important functions. We believe if you look at this cheat sheet, you can handle most of the network visualization problems.

### What we learned/ what might do differently next time

From this cheat sheet, we have learned how to draw a network graph in R correctly and clearly. Besides, we also learned how to tune the hyperparameters in igraph to make the network graph much easier to read and catch the key factors.

To further discover this package, we may consider using more layouts because different layouts have different advantages in some specific questions.
